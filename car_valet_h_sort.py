...
class Planner:
    ...
    def __init__(self,start, end, obstacles):
        ...
        self.meters2pixels = 4
        self.L = 3.0 * self.meters2pixels
        self.dt = 0.1
        self.max_v = 10.0 * self.meters2pixels
        self.motion_primitives = [(-self.max_v, -35), (-self.max_v, 0), (-self.max_v, 35), (self.max_v, -35), (self.max_v, 0), (self.max_v, 35)]
        self.test_vehicle = Vehicle(0, 0, (0, 0, 255), 0)
        self.dist_threshold = 10.0 * self.meters2pixels
